...
bool isSuperAdminLevel(String raw) =>
    raw.trim().toUpperCase() == 'SUPERADMIN';

/// Copies session fields from SharedPreferences into global vars in [var.dart].
Future<void> syncSessionFromPreferences() async {
